  ...
  return (
    <div className="body">
      <div className="notfound-copy">
        <svg aria-labelledby="404" alt="404 Page not found" className="not-found">
          <title id="svgtitle1">404 Page not found</title>
          <g className="404-text">
        ...
        <input id="input1" type="text" placeholder="Search" className='mt-4' />
        <svg className="search-icon" width="26" height="25.8">
          <path
            opacity=".4"
            fill="#68A1D6"
        ...
        <div className='flex flex-row gap-x-4 text-xl mt-8 justify-end '>
          <a href="#">Home</a>
          <a href="#">Locations</a>
